  ...
  const fetchLesson = async () => {
    try {
      ...
      if (res.ok) {
        ...
        setForm({
          title: lesson.title || '',
          category: lesson.category || 'English Hub',
          duration: lesson.duration || '',
          description: lesson.description || '',
          content: lesson.content || '',
          instructor: lesson.instructor || 'Robiul Islam',
          difficulty: lesson.difficulty || 'Intermediate',
          videoUrl: lesson.originalVideoUrl || lesson.videoUrl || '',
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-white/40 text-sm">Update lesson details</p>
        </div>
      </div>

      {/* Form — same structure as new lesson */}
