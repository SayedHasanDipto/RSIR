...
স্পেনের গ্রানাডার 'আলহামব্রা প্রাসাদ' বা ইস্তাম্বুলের 'সুলতান আহমেদ মসজিদ' (ব্লু মস্ক)-এর দিকে تাকালে দেখা যায় কীভাবে আলো, ছায়া এবং পানির প্রবাহকে জ্যামিতিক নকশার সাথে সমন্বয় করা হয়েছে। ক্যালিগ্রাফি এবং স্টুকো আর্টের সূক্ষ্ম কাজ দেয়ালগুলোকে জীবন্ত করে তুলেছে। এই স্থাপত্যগুলো ইসলামের বৈশ্বিক জ্ঞানচর্চা ও নন্দনতত্ত্বের জীবন্ত দলিল।`,
  ...
  },
  {
    ...
    date: '৮ মে, ২০২৬',
    readTime: '৮ মিনিট',
    excerpt: 'পবিত্র কুরআনের আয়াতসমূহর ঐতিহাসিক প্রেক্ষাপট, ভাষাগত অলংকার এবং সমকালীন জ্ঞান-বিজ্ঞানের সাথে তাদের যৌক্তিক সামঞ্জস্য নিয়ে একটি বুদ্ধিবৃত্তিক আলোচনা।',
...
ইবনে আল-হাইথাম (Alhazen) প্রথম প্রমাণ করলেন কীভাবে আমরা আলো দেখি এবং তার হাত ধরেই আবিষ্কৃত হলো ক্যামেরার আদি রূপ 'ক্যামেরা অবস্কিউরা' ও আধুনিক অপটিক্স। ইবনে সিনা (Avicenna)-এর চিকিৎসাশাস্ত্রের বিশ্বকোষ 'আল-কানুন ফিত-তিব' শত শত বছর ধরে ইউরোপের বিশ্ববিদ্যালয়গুলোতে প্রধান পাঠ্যবই হিসেবে ব্যবহৃত হয়েছে। আধুনিক সভ্যতার প্রতিটি পদে রয়েছে এই মহান বিজ্ঞানীদের অবদান।`,
  ...
  },
  {
    ...
    content: `ক্যালিগ্রাফি ইসলামী শিল্পকলার সবচেয়ে সম্মানিত ও নান্দনিক মাধ্যম। মূর্তিপূজা বা প্রতিকৃতি অঙ্কনের নিষেধাজ্ঞার প্রেক্ষাপট থেকে মুসলিম শিল্পীরা তাদের সমস্ত সৃজনশীলতা ঢেলে দিয়েছিলেন আল্লাহর পবিত্র বাণীকে অক্ষরের শৈলক্ষিক রূপ দেওয়ার কাজে।
...
export function ArticlesClient({ dbPosts = [] }) {
  ...
  // Map DB posts
  const formattedDbPosts = dbPosts.map((post, index) => ({
    id: post._id,
    slug: post.slug || post._id,
    title: post.title || 'Untitled',
    banglaTitle: post.banglaTitle || '',
    ...
    imageUrl: post.thumbnailUrl || 'https://images.unsplash.com/photo-1596125160970-6f02eeba00d3?w=800&q=80',
  ...
  const uniqueDbCategories = Array.from(new Set(formattedDbPosts.map(a => a.category)));
  const staticCategoryIds = staticCategories.map(c => c.id);
  const extraCategories = uniqueDbCategories
    .filter(cat => !staticCategoryIds.includes(cat) && cat !== 'General')
  ...
  const handleArticleAccess = (slug) => {
    ...
    if (isLoggedIn) {
      ...
      setSelectedArticle(null); // Close preview modal
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10 w-full flex-grow">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <p className="text-white/70 text-lg leading-relaxed font-medium">
            ইসলামী স্বর্ণযুগের সোনালী ইতিহাস, দর্শন, শিল্প ও যুগান্তকারী বৈজ্ঞানিক আবিষ্কারসমূহ নিয়ে সাজানো আমাদের সম্পূর্ণ আর্টিকেল ও গবেষণাপত্র আর্কাইভ।
          </p>
        </div>

        {/* Category Tabs / Filters */}
        <div className="flex justify-start sm:justify-center mb-12 overflow-x-auto pb-4 max-w-full">
          <div className="flex gap-2 sm:gap-4 bg-slate-900/50 backdrop-blur-md p-2 rounded-2xl border border-white/5 whitespace-nowrap">
            {categories.map((cat) => (
              <button
                key={cat.id}
        ...
        {/* Grid of Articles */}
        <StaggerReveal selector=".article-card-wrap">
          <motion.div 
            layout 
            ...
            <AnimatePresence mode="popLayout">
              {filteredArticles.map((article) => (
                <motion.div
                  ...
                  className="article-card-wrap bg-slate-900/40 backdrop-blur-md rounded-3xl overflow-hidden border border-white/5 hover:border-gold/30 shadow-xl hover:shadow-gold/5 transition-all duration-300 group cursor-pointer flex flex-col h-full relative"
                >
        ...
        {selectedArticle && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 md:p-10">
            ...
            <motion.div
              ...
              className="bg-[#0e1626] border border-white/10 rounded-3xl w-full max-w-3xl max-h-[85vh] overflow-y-auto relative z-10 shadow-2xl no-scrollbar flex flex-col text-white"
            >
              {/* Header Image Cover */}
              ...
              <div className="px-6 py-4 bg-[#0a0f1d]/80 backdrop-blur-md border-t border-white/5 flex justify-end gap-4 shrink-0">
                ...
                <button
                  onClick={() => handleArticleAccess(selectedArticle.slug || selectedArticle.id)}
