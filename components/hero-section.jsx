...
export function HeroSection() {
  ...
  useGSAP(() => {
    ...
    // Reduced delays and durations for snappier load
  ...
  return (
    ...
    >
      {/* Background — pure CSS animation, no JS overhead */}
      <div 
        className="absolute top-[-10%] right-[-10%] w-[500px] h-[500px] bg-gold/5 rounded-full blur-[100px] pointer-events-none animate-pulse-slow" 
      />
      <div 
        className="absolute bottom-[-10%] left-[-10%] w-[600px] h-[600px] bg-primary/5 rounded-full blur-[100px] pointer-events-none animate-pulse-slow-delayed" 
      />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div className="hero-content space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-5 justify-center md:justify-start">
              <button
                ...
                className="w-full sm:w-auto bg-primary hover:bg-primary-navy-light text-white px-8 md:px-10 py-4 rounded-xl font-bold transition-all duration-200 flex items-center justify-center gap-2 group hover:scale-[1.03] hover:shadow-lg active:scale-[0.98]"
              >
                Explore Lessons
              ...
              <button
                ...
                className="w-full sm:w-auto border-2 border-gold text-primary px-8 md:px-10 py-4 rounded-xl font-bold transition-all duration-200 text-center hover:scale-[1.03] hover:bg-gold/10 active:scale-[0.98]"
              >
                Learn More
              </button>
            </div>
          ...
          <div className="flex justify-center md:justify-end mt-12 md:mt-0">
            <div className="relative w-full max-w-sm md:max-w-md animate-float">
              ...
              <div
                className="relative bg-gradient-to-br from-primary via-primary-navy-light to-primary-navy rounded-3xl p-1 shadow-2xl overflow-hidden hero-image-wrapper hover:scale-[1.02] transition-transform duration-500"
              >
              ...
              <div
                className="absolute -bottom-4 -right-4 sm:-bottom-6 sm:-right-6 bg-card rounded-2xl p-4 sm:p-5 shadow-2xl border border-border/50 backdrop-blur-sm bg-card/95 hidden sm:block animate-slide-in-right"
              >
